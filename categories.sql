...
BEGIN
  ...
  VALUES ('CT' || TO_CHAR(seq_category_num.NEXTVAL), p_name, p_description, p_parent_id);
  COMMIT;
...
BEGIN
  UPDATE Category
    SET name = COALESCE(p_name, name),
        ...
        parent_id = COALESCE(p_parent_id, description)
